...
INSERT INTO DB_DreamKey.Suscripcion (fechaSuscripcion, fechaPagoSuscripcion, activaSuscripcion, Membresias_idMembresias) VALUES
('2025-05-01', '2025-05-31',1,LAST_INSERT_ID()),
('2025-05-05', '2025-06-05',1,LAST_INSERT_ID()),
('2025-04-15', '2025-05-15',1,LAST_INSERT_ID()),
('2025-05-10', '2025-06-10',1,LAST_INSERT_ID()),
('2025-04-20', '2025-05-20',0,LAST_INSERT_ID()),
('2025-04-28', '2025-05-20',1,LAST_INSERT_ID());

-- Datos para la tabla membresias
INSERT INTO DB_DreamKey.membresias (nombreMembresia, precioMembresia, categoriaMembresia, urlImagenMembresia,descripcionMembresia) VALUES
...
DELETE FROM membresias WHERE idMembresias > 0;
